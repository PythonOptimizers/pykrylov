# -*- coding: utf-8 -*-
#
# PyKrylov documentation build configuration file, created by
# sphinx-quickstart on Sun Dec  7 00:46:01 2008.
#
...
latex_documents = [
  ('contents', 'PyKrylov.tex', ur'PyKrylov Documentation',
   ur'D. Orban', 'manual'),
]
